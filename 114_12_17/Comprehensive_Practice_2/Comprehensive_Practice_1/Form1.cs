...
namespace Comprehensive_Practice_1
{
    public partial class Form1 : Form
    {
        ...
        private void showResult(string surname, string givenName, int quiz1, int quiz2, int quiz3)
        {
            ...
            highestScore = findHeightScore(quiz1, quiz2, quiz3);

            lblResult.Text = string.Format("{0}{1}的最高分是{2}", surname, givenName, highestScore);
        }
        private int findHeightScore(int quiz1, int quiz2, int quiz3)
        {
            int highestScore;
